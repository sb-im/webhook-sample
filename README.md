...
| POST | `/webhook/osd/device` | 接收设备 OSD 数据，返回成功响应；[`data` 字段说明](src/main/java/com/example/webhooksample/controller/OsdController.md) |
| POST | `/webhook/osd/sub-device` | 接收子设备 OSD 数据，返回成功响应；[`data` 字段说明](src/main/java/com/example/webhooksample/controller/OsdController.md#子设备-osd) |
